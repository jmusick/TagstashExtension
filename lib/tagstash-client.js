...
// The API answers 401 (no token) or 403 (invalid, expired or revoked token) from its auth
// check. None of the routes the extension calls use either status for anything else.
